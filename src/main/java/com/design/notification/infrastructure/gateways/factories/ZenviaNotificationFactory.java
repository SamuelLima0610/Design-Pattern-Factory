...
import com.design.notification.infrastructure.gateways.senders.ZenviaNotificationSender;
import com.design.notification.infrastructure.gateways.validators.SmsNotificationValidator;

@Component
public class ZenviaNotificationFactory implements NotificationAbstractFactory {

    private final ZenviaNotificationSender sender;
    ...
    public ZenviaNotificationFactory(
            ZenviaNotificationSender sender,
