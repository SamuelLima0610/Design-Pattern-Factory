...
public class TwilioNotificationSender implements NotificationSender {
    private static final Logger logger = LoggerFactory.getLogger(TwilioNotificationSender.class);

    @Override
    public void send(Notification notification) {
        logger.info("[Twilio] Enviando SMS para {}: {}", notification.getUser().getPhoneNumber(), notification.getMessage());
    }
}
